...
const Home = () => {
  return (
    <div className="flex-1 flex justify-center">
      <div
        aria-hidden="true"
        className="absolute top-[45%] left-[calc(50%-410px)] rotate-12"
      >
      ...
      <div
        aria-hidden="true"
        className="absolute top-1/2 right-[calc(50%-400px)] -rotate-6"
      >
      ...
      <div
        aria-hidden="true"
        className="absolute top-2/3 left-[calc(50%-390px)] rotate-[-20deg]"
      >
      ...
      <div
        aria-hidden="true"
        className="absolute top-[70%] right-[calc(50%-400px)] -rotate-18"
      >
